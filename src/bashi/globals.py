...
ALPAKA_ACC_ONEAPI_CPU_ENABLE: str = "alpaka_SYCL_ONEAPI_CPU"
ALPAKA_ACC_ONEAPI_GPU_ENABLE: str = "alpaka_SYCL_ONEAPI_GPU"
ALPAKA_ACC_ONEAPI_FPGA_ENABLE: str = "alpaka_SYCL_ONEAPI_FPGA"

CPU_BACKENDS: List[str] = [
